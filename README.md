...
| `sitegenesis.example.com` | `SITEGENESIS` | `PROXY_ORIGIN_SITEGENESIS`=`https://sitegenesis.example.com`<br/>`PWA_ORIGIN_SFRA`=`https://hybrid-sitegenesis.mobify-storefront.com`<br/>`SFCC_ORIGIN_SFRA`=`https://abcd-002.dx.commercecloud.salesforce.com`<br/>`SITEGENESIS_MRT_RULE_1`=rule1<br/>`SITEGENESIS_MRT_RULE_2`=rule2 |                                         |
